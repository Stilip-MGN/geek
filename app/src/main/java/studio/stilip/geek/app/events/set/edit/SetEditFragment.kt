...
@AndroidEntryPoint
class SetEditFragment : Fragment(R.layout.fragment_set_edit) {

    private val hostViewModel: HostViewModel by activityViewModels()
    private val viewModel: SetEditViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        hostViewModel.setToolbarTitle("Редактирование партии")
